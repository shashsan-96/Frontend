...
export const ORDER_UPDATE_SHIPPING_SUCCESS = 'ORDER_UPDATE_SHIPPING_SUCCESS';
export const ORDER_UPDATE_SHIPPING_REQUEST = 'ORDER_UPDATE_SHIPPING_REQUEST';
export const ORDER_UPDATE_SHIPPING_FAIL = 'ORDER_UPDATE_SHIPPING_FAIL';
export const ORDER_UPDATE_SHIPPING_RESET = 'ORDER_UPDATE_SHIPPING_RESET';