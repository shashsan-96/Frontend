...
<button className="cor22" value= "writing"><Link to={"/writing"} style={{textDecoration:'none',color:'white'}}>Click here</Link></button>
 <button className="cat2" value= "Office"><Link to={"/office"} style={{textDecoration:'none',color:'rgba(255, 255, 255, 0.055)'}}>Click here</Link></button>
</div>
